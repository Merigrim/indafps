...
public abstract class Actor extends Entity {
	...
	/**
	 * Restores the health of the actor. If amount is negative,
	 * the health will be decreased instead.
	...
	/**
	 * Restores the ammo of the actor. If amount is negative,
	 * the ammo will be decreased instead.
