...
public class Door extends Entity {
	...
	/**
	 * Check the position of the surrounding walls and
	 * determine which direction of the Door is most suitable.
	 * The Door will then change its direction to the newly
	 * found direction.
