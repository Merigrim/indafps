...
<<<<<<< HEAD
		...
		intersects[0] = line.intersects(new Parallelogram(c[0], c[1], c[2]));
		intersects[1] = line.intersects(new Parallelogram(c[0], c[1], c[3]));
		intersects[2] = line.intersects(new Parallelogram(c[0], c[2], c[3]));
		intersects[3] = line.intersects(new Parallelogram(c[4], c[5], c[6]));
		intersects[4] = line.intersects(new Parallelogram(c[4], c[5], c[7]));
		intersects[5] = line.intersects(new Parallelogram(c[4], c[6], c[7]));
