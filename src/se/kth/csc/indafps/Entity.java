...
public abstract class Entity implements GameComponent {
	...
	/**
	 * Sets the texture to this Entity. If texture is null,
	 * texturing on the object will be disabled.
	 */
	...
	/**
	 * Tests if the other Entity intersects with this Entity.
	 * It is guaranteed that A.testIntersection(B) is
	 * equivalence with B.testIntersection(A).
	 * @return True if there's an intersection, otherwise false.
	 */
